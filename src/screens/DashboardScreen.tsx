  ...
  try {
    ...
    if (parts.length === 3) {
      ...
      if (y && m && d) {
        ...
        if (cleanDate === todayStr) return `Today, ${day} ${monthName}`;
        if (cleanDate === yesterdayStr) return `Yesterday, ${day} ${monthName}`;
  ...
  return (
    <View style={styles.screenContainer}>
      ...
      <View style={styles.kpiGridContainer}>
        ...
        <TouchableOpacity
          activeOpacity={0.75}
          onPress={() => onOpenTab ? onOpenTab('salary') : onSelectCategory?.('Income')}
          style={[
            styles.kpiCard,
            {
        ...
        <View style={styles.barChartContainer}>
          ...
          <View style={styles.barsStage}>
            ...
            <View style={styles.barsRow}>
              ...
              <TouchableOpacity
                activeOpacity={0.75}
                onPress={() => onOpenTab ? onOpenTab('invest') : onSelectCategory?.('Investment')}
                style={styles.barColumn}
              >
                <View
                  style={[
              ...
              <TouchableOpacity
                activeOpacity={0.75}
                onPress={() => onOpenTab ? onOpenTab('loans') : onSelectCategory?.('EMI')}
                style={styles.barColumn}
              >
                <View
                  style={[
                  ...
                  <View style={styles.ledgerRowMain}>
                    ...
                    <View style={styles.ledgerTitleBlock}>
                      ...
                      <View style={styles.ledgerMetaRow}>
                        <TouchableOpacity
                          activeOpacity={0.7}
                          onPress={() => onSelectCategory ? onSelectCategory(tx.category) : onOpenTab?.('hisab')}
                          style={[
                            styles.categoryPill,
                            {
                              backgroundColor: visual.pillBg,
